...
class wasmtime_wasip2_config_t(ctypes.Structure):
    pass

_wasmtime_wasip2_config_new = dll.wasmtime_wasip2_config_new
_wasmtime_wasip2_config_new.restype = ctypes.POINTER(wasmtime_wasip2_config_t)
...
_wasmtime_wasip2_config_inherit_stdin.argtypes = [ctypes.POINTER(wasmtime_wasip2_config_t)]
...
_wasmtime_wasip2_config_inherit_stdout.argtypes = [ctypes.POINTER(wasmtime_wasip2_config_t)]
...
_wasmtime_wasip2_config_inherit_stderr.argtypes = [ctypes.POINTER(wasmtime_wasip2_config_t)]
...
_wasmtime_wasip2_config_arg.argtypes = [ctypes.POINTER(wasmtime_wasip2_config_t), ctypes.POINTER(ctypes.c_char), ctypes.c_size_t]
...
_wasmtime_wasip2_config_delete.argtypes = [ctypes.POINTER(wasmtime_wasip2_config_t)]
...
_wasmtime_context_set_wasip2.argtypes = [ctypes.POINTER(wasmtime_context_t), ctypes.POINTER(wasmtime_wasip2_config_t)]
...
_wasmtime_memorytype_new.restype = ctypes.POINTER(wasm_memorytype_t)
_wasmtime_memorytype_new.argtypes = [ctypes.c_uint64, ctypes.c_bool, ctypes.c_uint64, ctypes.c_bool, ctypes.c_bool]
...
wasmtime_component_func_callback_t = ctypes.CFUNCTYPE(ctypes.c_size_t, ctypes.c_void_p, ctypes.POINTER(wasmtime_context_t), ctypes.POINTER(wasmtime_component_val_t), ctypes.c_size_t, ctypes.POINTER(wasmtime_component_val_t), ctypes.c_size_t)
